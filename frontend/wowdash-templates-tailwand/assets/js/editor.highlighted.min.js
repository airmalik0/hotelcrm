...
const hljs = (() => {
  ...
  function R(e, n) {
    void 0 !== e.className &&
      ((e.scope = e.className), (e.className = undefined))
  }
  function D(e, n) {
    n &&
      e.beginKeywords &&
  ...
  function L(e, n) {
    if (e.match) {
      ...
      ;(e.begin = e.match), (e.match = undefined)
    }
  }
  function B(e, n) {
  ...
  function W(e) {
    ;((e) => {
      e.scope &&
        ...
        null !== e.scope &&
        ((e.beginScope = e.scope), (e.scope = undefined))
    })(e),
  ...
  const ne = (t) => {
      ...
      function N(a, r) {
        ...
        if (((y = r), "begin" === r.type))
          return ((e) => {
            ...
            const a = e.rule
            const i = new n(a)
            const r = [a.__beforeBegin, a["on:begin"]]
    ...
    function y(e) {
      ...
      const r = t ? h(a, { language: t, ignoreIllegals: !0 }) : E(a)
      ;(e.innerHTML = r.value),
  ...
  const de = oe.concat(le)
  const ge = "[0-9](_*[0-9])*"
  const ue = `\\.(${ge})`
  const be = "[0-9a-fA-F](_*[0-9a-fA-F])*"
  const me = {
    className: "number",
    variants: [
      {
  ...
  const fe = ["true", "false", "null", "undefined", "NaN", "Infinity"]
  const Ee = [
    "Object",
    "Function",
    "Boolean",
  ...
  function Oe(e) {
    ...
    const r = "[0-9](_?[0-9])*"
    const s = `\\.(${r})`
    const o = "0|[1-9](_?[0-9])*|0[0-7]*[89][0-9]*"
    const l = {
      className: "number",
      variants: [
        {
    ...
    const x = `(\\([^()]*(\\([^()]*(\\([^()]*\\)[^()]*)*\\)[^()]*)*\\)|${e.UNDERSCORE_IDENT_RE})\\s*=>`
    const M = {
      match: [
        /const|var|let/,
        /\s+/,
  ...
  const xe = ["Protocol", "Type"].map(ke)
  const Me = ["init", "self"].map(ke)
  const Se = ["Any", "Self"]
  const Ae = [
    "actor",
    "any",
  ...
  const Ke = Object.freeze({
    ...
    grmr_c: (e) => {
      ...
      const g = `${n.optional(i) + e.IDENT_RE}\\s*\\(`
      const u = {
        keyword: [
          "asm",
          "auto",
    ...
    grmr_csharp: (e) => {
      ...
      const r = e.inherit(i, { illegal: /\n/ })
      const s = { className: "subst", begin: /\{/, end: /\}/, keywords: n }
      const o = e.inherit(s, { illegal: /\n/ })
      const l = {
        className: "string",
        begin: /\$"/,
        end: '"',
    ...
    grmr_java: (e) => {
      const n = e.regex
      const t = "[\xc0-\u02b8a-zA-Z_$][\xc0-\u02b8a-zA-Z_$0-9]*"
      const a = t + pe(`(?:<${t}~~~(?:\\s*,\\s*${t}~~~)*>)?`, /~~~/g, 2)
      const i = {
        keyword: [
          "synchronized",
          "abstract",
    ...
    grmr_json: (e) => {
      ...
      const t = { scope: "literal", beginKeywords: n.join(" ") }
      return {
        name: "JSON",
        keywords: { literal: n },
        contains: [
    ...
    grmr_kotlin: (e) => {
      ...
      const t = { className: "symbol", begin: `${e.UNDERSCORE_IDENT_RE}@` }
      const a = {
        className: "subst",
        begin: /\$\{/,
        end: /\}/,
    ...
    grmr_less: (e) => {
      ...
      const l = (e, n, t) => ({ className: e, begin: n, relevance: t })
      const c = {
        $pattern: /[a-z-]+/,
        keyword: "and or not only",
        attribute: se.join(" "),
    ...
    grmr_lua: (e) => {
      const n = "\\[=*\\["
      const t = "\\]=*\\]"
      const a = { begin: n, end: t, contains: ["self"] }
      const i = [
        e.COMMENT(`--(?!${n})`, "$"),
    ...
    grmr_makefile: (e) => {
      ...
      const i = { begin: `^${e.UNDERSCORE_IDENT_RE}\\s*(?=[:+?]?=)` }
      const r = {
        className: "section",
        begin: /^[^\s]+:/,
        end: /$/,
    ...
    grmr_markdown: (e) => {
      ...
      const r = e.inherit(a, { contains: [] })
      const s = e.inherit(i, { contains: [] })
    ...
    grmr_perl: (e) => {
      ...
      const o = [e.BACKSLASH_ESCAPE, i, s]
      const l = [/!/, /\//, /\|/, /\?/, /'/, /"/, /#/]
      const c = (e, a, i = "\\1") => {
    ...
    grmr_php: (e) => {
      ...
      const o = e.inherit(e.APOS_STRING_MODE, { illegal: null })
      const l = "[ \t\n]"
      const c = {
        scope: "string",
        variants: [
    ...
    grmr_python: (e) => {
      const n = e.regex
      const t = /[\p{XID_Start}_]\p{XID_Continue}*/u
      const a = [
        "and",
        "as",
        "assert",
    ...
    grmr_ruby: (e) => {
      ...
      const c = { className: "subst", begin: /#\{/, end: /\}/, keywords: r }
      const d = {
        className: "string",
        contains: [e.BACKSLASH_ESCAPE, c],
        variants: [
    ...
    grmr_rust: (e) => {
      ...
      const a = "([ui](8|16|32|64|128|size)|f(32|64))?"
      const i = [
        "drop ",
        "Copy",
        "Send",
    ...
    grmr_swift: (e) => {
      ...
      const r = { match: b(/\./, m(...Ae)), relevance: 0 }
      const s = Ae.filter((e) => "string" === typeof e).concat(["_|0"])
      const o = {
        variants: [
          {
            className: "keyword",
      ...
      const T = [
        {
          ...
          starts: {
            contains: [
              { begin: /\(/, end: /\)/, keywords: Pe, contains: [...p, f, O] },
            ],
          },
        },
        {
    ...
    grmr_typescript: (e) => {
      ...
      const o = { className: "meta", begin: `@${t}` }
      const l = (e, n, t) => {
    ...
    grmr_xml: (e) => {
      ...
      const r = e.inherit(i, { begin: /\(/, end: /\)/ })
      const s = e.inherit(e.APOS_STRING_MODE, {
        className: "string",
      })
      const o = e.inherit(e.QUOTE_STRING_MODE, { className: "string" })
      const l = {
        endsWithParent: !0,
        illegal: /</,
        relevance: 0,
