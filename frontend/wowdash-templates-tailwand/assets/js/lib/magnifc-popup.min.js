...
!((a) => {
  ...
  const x = (b, c, d, e) => {
    ...
    return (
      (f.className = `mfp-${b}`),
      d && (f.innerHTML = d),
      e ? c?.appendChild(f) : ((f = a(f)), c && f.appendTo(c)),
      f
    )
  }
  const y = (c, d) => {
  ...
  ;(t.prototype = {
    ...
    _onFocusIn: (c) =>
      c.target === b.wrap[0] || a.contains(b.wrap[0], c.target)
        ? void 0
        : (b._setFocus(), !1),
    _parseMarkup: (b, c, d) => {
      let e
    ...
    (a.magnificPopup = {
      ...
      close: () => a.magnificPopup.instance?.close(),
    ...
    (a.fn.magnificPopup = function (c) {
      ...
      if ("string" === typeof c)
        if ("open" === c) {
          ...
          const g = Number.parseInt(arguments[1], 10) || 0
          f.items
            ? (e = f.items[g])
    ...
    proto: {
      ...
      getImage: (c, d) => {
        ...
        if (i.length) {
          ...
          ;(j.className = "mfp-img"),
            c.el?.find("img").length && (j.alt = c.el.find("img").attr("alt")),
  ...
  a.magnificPopup.registerModule("zoom", {
    ...
    proto: {
      initZoom: () => {
        ...
        if (c.enabled && b.supportsTransition) {
          ...
          w(`BuildControls${d}`, () => {
            ...
            w(h + d, () => {
              b._allowZoom() && (k(), f?.remove(), (a = null))
            })
        }
      },
      ...
      _getOffset: (c) => {
        ...
        const e = d.offset()
        const f = Number.parseInt(d.css("padding-top"), 10)
        const g = Number.parseInt(d.css("padding-bottom"), 10)
  ...
  const T = (a, b, c) => a.replace(/%curr%/gi, b + 1).replace(/%total%/gi, c)
