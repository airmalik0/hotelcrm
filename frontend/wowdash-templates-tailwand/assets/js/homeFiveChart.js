...
const chart = new ApexCharts(document.querySelector("#upDownBarchart"), options)
chart.render()
...
const chart = new ApexCharts(
  document.querySelector("#dailyIconBarChart"),
  options,
)
chart.render()
...
const chart = new ApexCharts(
  document.querySelector("#transactionLineChart"),
  options,
)
chart.render()
