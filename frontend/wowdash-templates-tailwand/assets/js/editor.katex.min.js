...
!((e, t) => {
  ...
  (() => {
      ...
      if (o && o.start <= o.end) {
        ...
        ;(n = o.start),
          ...
          n === s.length
            ? (i += " at end of input: ")
            : (i += ` at position ${n + 1}: `)
        const l = s.slice(n, a).replace(/[^]/g, "$&\u0332")
        i +=
    ...
    const l = {
      ...
      deflt: (e, t) => (void 0 === e ? t : e),
      escape: (e) => String(e).replace(o, (e) => i[e]),
      hyphenate: (e) => e.replace(a, "-$1").toLowerCase(),
      getBaseElem: s,
      isCharacterBox: (e) => {
        const t = s(e)
    ...
    const h = {
      ...
      minRuleThickness: {
        ...
        cliProcessor: Number.parseFloat,
      },
      colorIsTextColor: {
        type: "boolean",
        description:
      ...
      maxExpand: {
        ...
        processor: (e) => Math.max(0, e),
        cli: "-e, --max-expand <n>",
        cliProcessor: (e) => ("Infinity" === e ? 1 / 0 : Number.parseInt(e)),
      },
    ...
    const m = (() => {
      function e(e) {
        for (const t in ((this.displayMode = void 0),
        (this.output = void 0),
        (this.leqno = void 0),
        (this.fleqn = void 0),
        ...
        (t.reportNonstrict = function (e, t, r) {
          ...
          if (
            ...
            "warn" === a
              ...
              : "undefined" !== typeof console &&
                console.warn(
                  `LaTeX-incompatible input and strict mode is set to unrecognized '${a}': ${t} [${e}]`,
                )
          }
        }),
          ...
          return (
            ...
            (!0 === n ||
              ...
              ("warn" === n
                ...
                : ("undefined" !== typeof console &&
                    console.warn(
                      `LaTeX-incompatible input and strict mode is set to unrecognized '${n}': ${t} [${e}]`,
                    ),
                  !1)))
          )
        }),
    ...
    let d = [4, 5, 4, 5, 6, 7, 6, 7]
    const f = [5, 5, 5, 5, 7, 7, 7, 7]
    const g = [2, 3, 4, 5, 6, 7, 6, 7]
    const v = [3, 3, 5, 5, 7, 7, 7, 7]
    const b = [1, 1, 3, 3, 5, 5, 7, 7]
    const y = [0, 1, 2, 3, 2, 3, 2, 3]
    const x = { DISPLAY: p[0], TEXT: p[2], SCRIPT: p[4], SCRIPTSCRIPT: p[6] }
    const w = [
      {
        name: "latin",
        blocks: [
    ...
    w.forEach((e) => e.blocks.forEach((e) => k.push.apply(k, e)))
    const M = 80
    const z = {
      doubleleftarrow:
    ...
    const A = (() => {
      ...
      return (
        ...
        (t.toNode = function () {
          for (
            let e = document.createDocumentFragment(), t = 0;
        ...
        (t.toMarkup = function () {
          for (let e = "", t = 0; t < this.children.length; t++)
    ...
    const R = [0.5, 0.6, 0.7, 0.8, 0.9, 1, 1.2, 1.44, 1.728, 2.074, 2.488]
    const H = (e, t) => (t.size < 2 ? e : I[e - 1][t.size - 1])
    const O = (() => {
      function e(t) {
        ;(this.style = void 0),
          (this.color = void 0),
            ...
            this._fontMetrics ||
              (this._fontMetrics = ((e) => {
                ...
                if (!q[(t = e >= 5 ? 0 : e >= 3 ? 1 : 2)]) {
                  const r = (q[t] = { cssEmPerMu: B.quad[t] / 18 })
                  for (const n in B) B.hasOwnProperty(n) && (r[n] = B[n][t])
                }
                return q[t]
              })(this.size)),
            this._fontMetrics
    ...
    const F = (e) => `${+e.toFixed(4)}em`
    const G = (e) => e.filter((e) => e).join(" ")
    ...
    const Y = function (e) {
      ...
      for (const r in ((t.className = G(this.classes)), this.style))
    ...
    const X = function (e) {
      ...
      for (const a in (r && (t += ` style="${l.escape(r)}"`), this.attributes))
      ...
      function e(e, t, r, n, a, i, o, s) {
        ...
        const l = ((e) => {
          for (let t = 0; t < w.length; t++)
            for (let r = w[t], n = 0; n < r.blocks.length; n++) {
              const a = r.blocks[n]
      ...
      return (
        ...
        (t.toMarkup = function () {
          ...
          this.classes.length &&
            ...
            (t += '"'))
          let r = ""
          for (const n in (this.italic > 0 &&
            (r += `margin-right:${this.italic}em;`),
          this.style))
            this.style.hasOwnProperty(n) &&
              (r += `${l.hyphenate(n)}:${this.style[n]};`)
          r && ((e = !0), (t += ` style="${l.escape(r)}"`))
          const a = l.escape(this.text)
    ...
    ie(se, le, xe, "\u2013", "--", !0),
      ...
      ie(oe, he, xe, "\u2720", "\\maltese"),
      ie(se, he, xe, "\u2720", "\\maltese")
    for (let ke = '0123456789/@."', Se = 0; Se < ke.length; Se++) {
      const Me = ke.charAt(Se)
      ie(oe, le, xe, Me, Me)
    }
    for (let ze = '0123456789!@*()-=+";:?/.,', Ae = 0; Ae < ze.length; Ae++) {
      const Te = ze.charAt(Ae)
      ie(se, le, xe, Te, Te)
    }
    for (
      let Be = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz", Ce = 0;
      Ce < Be.length;
      Ce++
    ) {
      const Ne = Be.charAt(Ce)
    ...
    ie(oe, he, xe, "C", "\u2102"),
      ...
      ie(oe, le, de, "h", "\u210e"),
      ie(se, le, de, "h", "\u210e")
    for (let qe = "", Ie = 0; Ie < Be.length; Ie++) {
      const Re = Be.charAt(Ie)
    ...
    for (let Ee = "\xd0\xde\xfe", Le = 0; Le < Ee.length; Le++) {
      const De = Ee.charAt(Le)
    ...
    const Fe = (e, t, r) => (
      ae[r][e]?.replace && (e = ae[r][e].replace),
    ...
    const Ye = (e) => {
      for (let t = 0, r = 0, n = 0, a = 0; a < e.children.length; a++) {
    ...
    const Xe = (e, t, r, n) => {
      const a = new W(e, t, r, n)
      return Ye(a), a
    }
    const We = (e, t, r, n) => new W(e, t, r, n)
    const _e = (e) => {
      const t = new A(e)
      return Ye(t), t
    }
    ...
    const Ke = {
      ...
      makeAnchor: (e, t, r, n) => {
        const a = new _(e, t, r, n)
        return Ye(a), a
      },
      makeFragment: _e,
      wrapFragment: (e, t) => (e instanceof A ? Xe([], [e], t) : e),
      makeVList: (e, t) => {
        for (
          let r = ((e) => {
              if ("individualShift" === e.positionType) {
                for (
                  ...
                  const o = -t[i].shift - a - t[i].elem.depth
                  const s = o - (t[i - 1].elem.height + t[i - 1].elem.depth)
        ...
        const h = Xe(["pstrut"], [])
        h.style.height = F(i)
        for (let c = [], m = a, u = a, p = a, d = 0; d < n.length; d++) {
          const f = n[d]
          if ("kern" === f.type) p += f.size
          else {
            const g = f.elem
            const v = f.wrapperClasses || []
            const b = f.wrapperStyle || {}
            const y = Xe(v, [h, g], void 0, b)
        ...
        if (((w.style.height = F(u)), m < 0)) {
          ...
          const S = Xe(["vlist"], [k])
          S.style.height = F(-m)
          const M = Xe(["vlist-s"], [new Z("\u200b")])
          x = [Xe(["vlist-r"], [w, M]), Xe(["vlist-r"], [S])]
        } else x = [Xe(["vlist-r"], [w])]
        const z = Xe(["vlist-t"], x)
        return (
      ...
      makeOrd: (e, t, r) => {
        ...
        const i = e.text
        const o = ["mord"]
        const s = "math" === a || ("text" === a && t.font)
        const l = s ? t.font : t.fontFamily
        let h = ""
        let c = ""
        if (55349 === i.charCodeAt(0)) {
          const m = ((e, t) => {
            ...
            if (119808 <= r && r < 120484) {
              const i = Math.floor((r - 119808) / 26)
              return [Ve[i][2], Ve[i][a]]
            }
            if (120782 <= r && r <= 120831) {
              const o = Math.floor((r - 120782) / 10)
        ...
        if (l) {
          ...
          if ("boldsymbol" === l) {
            const d = ((e, t, r, n, a) =>
              "textord" !== a && Fe(e, "Math-BoldItalic", t).metrics
                ? { fontName: "Math-BoldItalic", fontClass: "boldsymbol" }
                : { fontName: "Main-Bold", fontClass: "mathbf" })(i, a, 0, 0, r)
        ...
        if ("textord" === r) {
          const v = ae[a][i]?.font
          if ("ams" === v) {
            const b = je("amsrm", t.fontWeight, t.fontShape)
            return Ge(i, b, a, t, o.concat("amsrm", t.fontWeight, t.fontShape))
          }
          if ("main" !== v && v) {
            const y = je(v, t.fontWeight, t.fontShape)
            return Ge(i, y, a, t, o.concat(y, t.fontWeight, t.fontShape))
          }
          const x = je("textrm", t.fontWeight, t.fontShape)
    ...
    const Je = { number: 3, unit: "mu" }
    const Qe = { number: 4, unit: "mu" }
    const et = { number: 5, unit: "mu" }
    const tt = {
    ...
    const lt = (e) =>
      "ordgroup" === e.type && 1 === e.body.length ? e.body[0] : e
    const ht = (e) => ("ordgroup" === e.type ? e.body : [e])
    const ct = Ke.makeSpan
    const mt = ["leftmost", "mbin", "mopen", "mrel", "mop", "mpunct"]
    const ut = ["rightmost", "mrel", "mclose", "mpunct"]
    const pt = {
      display: x.DISPLAY,
      text: x.TEXT,
      script: x.SCRIPT,
    ...
    const ft = (e, t, r, n) => {
      ...
      const m = ct([n[0] || "leftmost"], [], t)
      const u = ct([n[1] || "rightmost"], [], t)
      const p = "root" === r
      return (
        gt(
          a,
    ...
    const yt = (e, t) =>
      e ? (t && (e = bt(e, t)), dt[e.classes[0]] || null) : null
    const xt = (e, t) => {
    ...
    const wt = (e, t, r) => {
      ...
      if (at[e.type]) {
        ...
        if (r && t.size !== r.size) {
          ...
          const i = t.sizeMultiplier / r.sizeMultiplier
    ...
    function St(e, t) {
      ...
      for (let i, o = [], s = [], l = 0; l < a.length; l++)
        if (
          (s.push(a[l]),
          a[l].hasClass("mbin") ||
            a[l].hasClass("mrel") ||
      ...
      s.length > 0 && o.push(kt(s, t)),
        r
          ...
          : n && o.push(n)
      const c = ct(["katex-html"], o)
      if ((c.setAttribute("aria-hidden", "true"), i)) {
        const m = i.children[0]
    ...
    const Ct = (e) => (1 === e.length ? e[0] : new Tt.MathNode("mrow", e))
    const Nt = (e, t) => {
      ...
      return l.contains(["\\imath", "\\jmath"], a)
        ? null
        : (ae[n][a]?.replace && (a = ae[n][a].replace),
    ...
    function Ht(e, t, r, n, a) {
      ...
      const s = new Tt.MathNode("annotation", [new Tt.TextNode(t)])
      s.setAttribute("encoding", "application/x-tex")
      const h = new Tt.MathNode("semantics", [i, s])
      const c = new Tt.MathNode("math", [h])
      c.setAttribute("xmlns", "http://www.w3.org/1998/Math/MathML"),
        n && c.setAttribute("display", "block")
      const m = a ? "katex" : "katex-mathml"
    ...
    const Lt = (e, t, r) => {
      ...
      if ("html" === r.output) {
        ...
        const o = Ht(e, t, a, r.displayMode, !1)
        const s = St(e, a)
    ...
    const Pt = (e, t, r, n, a) => {
      let i
      const o = e.height + e.depth + r + n
      if (/fbox|color|angl/.test(t)) {
        if (((i = Ke.makeSpan(["stretchy", t], [], a)), "fbox" === t)) {
          const s = a.color && a.getColor()
        ...
        const h = new K(l, { width: "100%", height: F(o) })
        i = Ke.makeSvgSpan([], [h], a)
      }
      return (i.height = o), (i.style.height = F(o)), i
    }
    const Ft = (e) => {
      const t = new Tt.MathNode("mo", [
    ...
    const Gt = (e, t) => {
      const r = (() => {
        ...
        for (let k = 0; k < w; k++) {
          ...
          const z = Ke.makeSvgSpan([u[k]], [M], t)
    ...
    const Wt = (e, t) => {
      ...
      const i = wt(r, t.havingCrampedStyle())
      let o = 0
      if (n.isShifty && l.isCharacterBox(r)) {
        const s = l.getBaseElem(r)
      ...
      const g = Ke.makeSpan(["mord", "accent"], [h], t)
      return a
        ? ((a.children[0] = g),
    ...
    const _t = (e, t) => {
      ...
      const n = new Tt.MathNode("mover", [Rt(e.base, t), r])
    ...
    ot({
      ...
      ot({
        ...
        htmlBuilder: (e, t) => {
          const r = wt(e.base, t)
          const n = Gt(e, t)
          const a = "\\utilde" === e.label ? 0.12 : 0
          const i = Ke.makeVList(
            {
              positionType: "top",
        ...
        mathmlBuilder: (e, t) => {
          const r = Ft(e.label)
          const n = new Tt.MathNode("munder", [Rt(e.base, t), r])
          return n.setAttribute("accentunder", "true"), n
        },
      })
    const $t = (e) => {
      const t = new Tt.MathNode("mpadded", e ? [e] : [])
      return (
    ...
    ot({
      ...
      htmlBuilder: (e, t) => {
        let r
        const n = t.style
        let a = t.havingStyle(n.sup())
        const i = Ke.wrapFragment(wt(e.body, a, t), t)
        const o = "\\x" === e.label.slice(0, 2) ? "x" : "cd"
        ...
        let s
        const l = Gt(e, t)
        const h = -t.fontMetrics().axisHeight + 0.5 * l.height
        let c = -t.fontMetrics().axisHeight - 0.5 * l.height - 0.111
        if (
    ...
    ot({
      ...
      ot({
        ...
        htmlBuilder: (e, t) => {
          const r = ft(e.body, t, !0)
          const n = Ke.makeSpan([e.mclass], r, t)
          return (n.style.textShadow = "0.02em 0.01em 0.04px"), n
        },
        mathmlBuilder: (e, t) => {
          const r = qt(e.body, t)
          const n = new Tt.MathNode("mstyle", r)
    ...
    const tr = (e) => "textord" === e.type && "@" === e.text
    function rr(e, t, r) {
      const n = er[e]
      switch (n) {
        case "\\\\cdrightarrow":
        ...
        case "\\uparrow":
        case "\\downarrow": {
          const a = { type: "atom", text: n, mode: "math", family: "rel" }
          const i = {
            type: "ordgroup",
            mode: "math",
            body: [
    ...
    ot({
      ...
      htmlBuilder: (e, t) => {
        ...
        const n = Ke.wrapFragment(wt(e.label, r, t), t)
        return (
      ...
      mathmlBuilder: (e, t) => {
        let r = new Tt.MathNode("mrow", [Rt(e.label, t)])
        return (
      ...
      ot({
        ...
        htmlBuilder: (e, t) => {
          const r = Ke.wrapFragment(wt(e.fragment, t), t)
      ...
      ot({
        ...
        handler: (e, t) => {
          for (
            let r = e.parser, a = Ut(t[0], "ordgroup").body, i = "", o = 0;
            o < a.length;
            o++
          ) {
    ...
    const nr = (e, t) => {
      const r = ft(e.body, t.withColor(e.color), !1)
      return Ke.makeFragment(r)
    }
    const ar = (e, t) => {
      const r = qt(e.body, t.withColor(e.color))
      const n = new Tt.MathNode("mstyle", r)
    ...
    ot({
      ...
      ot({
        ...
        handler: (e, t) => {
          const r = e.parser
          const n = e.breakOnTokenText
          const a = Ut(t[0], "color-token").color
          r.gullet.macros.set("\\current@color", a)
          const i = r.parseExpression(!0, n)
      ...
      ot({
        ...
        handler: (e, t, r) => {
          const n = e.parser
          const a = "[" === n.gullet.future().text ? n.parseSizeGroup(!0) : null
          const i =
        ...
        mathmlBuilder: (e, t) => {
          const r = new Tt.MathNode("mspace")
          return (
            e.newLine &&
    ...
    const sr = (e, t, r, n) => {
      let a = e.gullet.macros.get(r.text)
      null == a &&
        ((r.noexpand = !0),
        (a = {
          tokens: [r],
    ...
    ot({
      ...
      ot({
        ...
        handler: (e) => {
          const t = e.parser
          const r = e.funcName
          let a = t.gullet.popToken()
          const i = a.text
          if (/^(?:[\\{}$&#^_]|EOF)$/.test(i))
            throw new n("Expected a control sequence", a)
          for (let o, s = 0, l = [[]]; "{" !== t.gullet.future().text; )
          ...
          let h = t.gullet.consumeArg().tokens
          return (
            o && h.unshift(o),
            ("\\edef" !== r && "\\xdef" !== r) ||
      ...
      ot({
        ...
        handler: (e) => {
          ...
          const r = e.funcName
          const n = or(t.gullet.popToken())
          const a = t.gullet.popToken()
          const i = t.gullet.popToken()
          return (
    ...
    const lr = (e, t, r) => {
      const n = N(ae.math[e]?.replace || e, t, r)
      if (!n) throw new Error(`Unsupported symbol ${e} and font size ${t}.`)
      return n
    }
    const hr = (e, t, r, n) => {
      const a = r.havingBaseStyle(t)
      const i = Ke.makeSpan(n.concat(a.sizingClasses(r)), [e], r)
      const o = a.sizeMultiplier / r.sizeMultiplier
      return (
    ...
    const mr = (e, t, r, n, a, i) => {
      const o = ((e, t, r, n) => Ke.makeSymbol(e, `Size${t}-Regular`, r, n))(
        e,
        t,
        a,
        n,
    ...
    const dr = { type: "kern", size: -0.008 }
    const fr = ["|", "\\lvert", "\\rvert", "\\vert"]
    const gr = ["\\|", "\\lVert", "\\rVert", "\\Vert"]
    const vr = (e, t, r, n, a, i) => {
      let o
      let s
      let h
      let c
                                            ...
                                            : "\\rgroup" === e || "\u27ef" === e
                                              ...
                                              : "\\lmoustache" === e ||
                                                ...
                                                : ("\\rmoustache" !== e &&
                                                  ...
                                                  (p = "Size4-Regular"))
      const d = lr(o, p, a)
      const f = d.height + d.depth
      const g = lr(h, p, a)
      const v = g.height + g.depth
      const b = lr(c, p, a)
      const y = b.height + b.depth
      let w = 0
      let k = 1
      if (null !== s) {
        const S = lr(s, p, a)
      ...
      const M = f + y + w
      const z = M + Math.max(0, Math.ceil((t - M) / (k * v))) * k * v
      let A = n.fontMetrics().axisHeight
      r && (A *= n.sizeMultiplier)
      const T = z / 2 - A
      const B = []
      if (m.length > 0) {
        const C = z - f - y
        const N = Math.round(1e3 * z)
        const q = ((e, t) => {
          switch (e) {
            case "lbrack":
        ...
        const I = new J(m, q)
        const R = `${(u / 1e3).toFixed(3)}em`
        const H = `${(N / 1e3).toFixed(3)}em`
        const O = new K([I], { width: R, height: H, viewBox: `0 0 ${u} ${N}` })
        const E = Ke.makeSvgSpan([], [O], n)
        ;(E.height = N / 1e3),
          (E.style.width = R),
          (E.style.height = H),
      ...
      const V = n.havingBaseStyle(x.TEXT)
      const P = Ke.makeVList(
    ...
    const Br = (e, t, r, n) => {
      for (
        let a = Math.min(2, 3 - n.style.size);
        a < r.length && "stack" !== r[a].type;
        a++
      ) {
        const i = lr(e, Tr(r[a]), "math")
    ...
    const Cr = (e, t, r, n, a, i) => {
      ...
      return "small" === s.type
        ? ((e, t, r, n, a, i) => {
            const o = Ke.makeSymbol(e, "Main-Regular", a, n)
            const s = hr(o, t, n, i)
            return r && cr(s, n, t), s
          })(e, s.style, r, n, a, i)
        : "large" === s.type
    ...
    const Nr = {
      sqrtImage: (e, t) => {
        let r
        let n
        const a = t.havingBaseSizing()
        const i = Br("\\surd", e * a.sizeMultiplier, Ar, a)
        let o = a.sizeMultiplier
        const s = Math.max(
          0,
      ...
      sizeToMaxHeight: Sr,
      customSizedDelim: Cr,
      leftRightDelim: (e, t, r, n, a, i) => {
        const o = n.fontMetrics().axisHeight * n.sizeMultiplier
        const s = 5 / n.fontMetrics().ptPerEm
        const l = Math.max(t - o, r + o)
        const h = Math.max((l / 500) * 901, 2 * l - s)
    ...
    ot({
      ...
      mathmlBuilder: (e) => {
        ...
        const r = new Tt.MathNode("mo", t)
        "mopen" === e.mclass || "mclose" === e.mclass
          ? r.setAttribute("fence", "true")
          : r.setAttribute("fence", "false"),
          r.setAttribute("stretchy", "true")
        const n = F(Nr.sizeToMaxHeight[e.size])
      ...
      ot({
        ...
        handler: (e, t) => {
          ...
          const n = e.parser
          ++n.leftrightDepth
          const a = n.parseExpression(!1)
          --n.leftrightDepth, n.expect("\\right", !1)
          const i = Ut(n.parseFunction(), "leftright-right")
          return {
            type: "leftright",
            mode: n.mode,
            body: a,
        ...
        htmlBuilder: (e, t) => {
          ...
          if (
            ...
            for (let h = 1; h < a.length; h++) {
              const c = a[h].isMiddle
              c &&
                (a[h] = Nr.leftRightDelim(c.delim, i, o, c.options, e.mode, []))
            }
          if ("." === e.right) n = xt(t, ["mclose"])
          else {
            const m = e.rightColor ? t.withColor(e.rightColor) : t
        ...
        mathmlBuilder: (e, t) => {
          ...
          const r = qt(e.body, t)
          if ("." !== e.left) {
            const n = new Tt.MathNode("mo", [Bt(e.left, e.mode)])
            n.setAttribute("fence", "true"), r.unshift(n)
          }
          if ("." !== e.right) {
            const a = new Tt.MathNode("mo", [Bt(e.right, e.mode)])
    ...
    const Or = (e, t) => {
      ...
      let n
      let a
      const i = Ke.wrapFragment(wt(e.body, t), t)
      const o = e.label.slice(1)
      let s = t.sizeMultiplier
      let h = 0
      const c = l.isCharacterBox(e.body)
      if ("sout" === o)
        ((r = Ke.makeSpan(["stretchy", "sout"])).height =
          t.fontMetrics().defaultRuleThickness / s),
          (h = -0.5 * t.fontMetrics().xHeight)
      else if ("phase" === o) {
        const m = P({ number: 0.6, unit: "pt" }, t)
        const u = P({ number: 0.35, unit: "ex" }, t)
        s /= t.havingBaseSizing().sizeMultiplier
        const p = i.height + i.depth + m + u
        i.style.paddingLeft = F(p / 2 + m)
        const d = Math.floor(1e3 * p * s)
        const f = `M400000 ${(n = d)} H0 L${n / 2} 0 l65 45 L145 ${n - 80} H400000z`
        const g = new K([new J("phase", f)], {
          width: "400em",
          height: F(d / 1e3),
      ...
      if (e.backgroundColor)
        ...
        const x = /cancel|phase/.test(o) ? ["svg-align"] : []
        a = Ke.makeVList(
          {
            positionType: "individualShift",
            children: [
      ...
      switch (e.label) {
        ...
        case "\\colorbox":
          if (
            ...
            const a = Math.max(t.fontMetrics().fboxrule, t.minRuleThickness)
            n.setAttribute(
              "style",
    ...
    ot({
      ...
      handler: (e, t, r) => {
        const n = e.parser
        const a = e.funcName
        const i = Ut(t[0], "color-token").color
        const o = t[1]
        return {
          type: "enclose",
          mode: n.mode,
      ...
      ot({
        ...
        handler: (e, t, r) => {
          ...
          const a = e.funcName
          const i = Ut(t[0], "color-token").color
          const o = Ut(t[1], "color-token").color
          const s = t[2]
          return {
            type: "enclose",
            mode: n.mode,
    ...
    const Fr = (() => {
      ...
      return (
        (e.range = (t, r) =>
          r
            ? t?.loc && r.loc && t.loc.lexer === r.loc.lexer
    ...
    function Wr(e, t, r) {
      const a = t.hskipBeforeAndAfter
      const i = t.addJot
      const o = t.cols
      let s = t.arraystretch
      const l = t.colSeparationType
      const h = t.autoTag
      const c = t.singleRow
      const m = t.emptySingleRow
      const u = t.maxNumCols
      const p = t.leqno
      if (
        (e.gullet.beginGroup(),
        ...
        const d = e.gullet.expandMacroAsText("\\arraystretch")
        if (null == d) s = 1
        else if (!(s = Number.parseFloat(d)) || s < 0)
      ...
      for (x(), b.push(Ur(e)); ; ) {
        let k = e.parseExpression(!1, c ? "\\end" : "\\\\")
        e.gullet.endGroup(),
          e.gullet.beginGroup(),
    ...
    const jr = (e, t) => {
      let r
      let a
      const i = e.body.length
      const o = e.hLinesBeforeRow
      let s = 0
      let h = new Array(i)
      const c = []
      const m = Math.max(t.fontMetrics().arrayRuleWidth, t.minRuleThickness)
      const u = 1 / t.fontMetrics().ptPerEm
      let p = 5 * u
      e.colSeparationType &&
        "small" === e.colSeparationType &&
        (p =
          (t.havingStyle(x.SCRIPT).sizeMultiplier / t.sizeMultiplier) * 0.2778)
      const d =
        "CD" === e.colSeparationType ? P({ number: 3, unit: "ex" }, t) : 12 * u
      const f = 3 * u
      const g = e.arraystretch * d
      const v = 0.7 * g
      const b = 0.3 * g
      let y = 0
      function w(e) {
      ...
      let C
      let N
      const q = y / 2 + t.fontMetrics().axisHeight
      const I = e.cols || []
      const R = []
      const H = []
      if (e.tags?.some((e) => e))
      ...
      for (a = 0, N = 0; a < s || N < I.length; ++a, ++N) {
        for (let V = I[N] || {}, G = !0; "separator" === V.type; ) {
          if (
            (G ||
          ...
          const U = "|" === V.separator ? "solid" : "dashed"
          const Y = Ke.makeSpan(["vertical-separator"], [], t)
          ;(Y.style.height = F(y)),
      ...
      if (((h = Ke.makeSpan(["mtable"], R)), c.length > 0)) {
        for (
          const K = Ke.makeLineSpan("hline", t, m),
      ...
      let re = Ke.makeVList({ positionType: "individualShift", children: H }, t)
      return (re = Ke.makeSpan(["tag"], [re], t)), Ke.makeFragment([h, re])
    }
    const $r = { c: "center ", l: "left ", r: "right " }
    const Zr = (e, t) => {
      for (
        let r = [],
      ...
      if ("align" === e.colSeparationType) {
        for (let y = e.cols || [], x = "", w = 1; w < y.length; w++)
          x += w % 2 ? "0em " : "1em "
    ...
    const Kr = (e, t) => {
      ...
      let r
      const a = []
      const i = e.envName.indexOf("at") > -1 ? "alignat" : "align"
      const o = "split" === e.envName
      const s = Wr(
        e.parser,
        {
          cols: a,
      ...
      if (t[0] && "ordgroup" === t[0].type) {
        for (let c = "", m = 0; m < t[0].body.length; m++) {
    ...
    Dr({
      ...
      props: { numArgs: 1 },
      handler: (e, t) => {
        const r = (Xt(t[0]) ? [t[0]] : Ut(t[0], "ordgroup").body).map((e) => {
          const t = Yt(e).text
        ...
        const a = { cols: r, hskipBeforeAndAfter: !0, maxNumCols: r.length }
      ...
      Dr({
        ...
        handler: (e) => {
          ...
          const o = Wr(e.parser, a, _r(e.envName))
          const s = Math.max.apply(
            Math,
            [0].concat(o.body.map((e) => e.length)),
          )
          return (
      ...
      Dr({
        ...
        props: { numArgs: 0 },
        handler: (e) => {
          const t = Wr(e.parser, { arraystretch: 0.5 }, "script")
      ...
      Dr({
        ...
        handler: (e, t) => {
          ...
          let a = { cols: r, hskipBeforeAndAfter: !1, arraystretch: 0.5 }
          if (
      ...
      Dr({
        ...
        handler: (e) => (
          ...
          ((e) => {
            ...
            for (let a, i, o = [], s = [o], l = 0; l < t.length; l++) {
              for (
                let h = t[l],
                  c = {
                    type: "styling",
                ...
                if (tr(h[m])) {
                  ...
                  if (
                    ...
                    for (let d = 0; d < 2; d++) {
                      for (let f = !0, g = m + 1; g < h.length; g++) {
                        if (
                          ((i = u),
                          ("mathord" === (a = h[g]).type ||
                            "atom" === a.type) &&
    ...
    ot({
      ...
      handler: (e, t) => {
        ...
        for (let o = "", s = 0; s < i.body.length; ++s)
          o += Ut(i.body[s], "textord").text
        if ("\\begin" === a) {
          if (!Jr.hasOwnProperty(o)) throw new n(`No such environment: ${o}`, i)
          const l = Jr[o]
          const h = r.parseArguments(`\\begin{${o}}`, l)
          const c = h.args
          const m = h.optArgs
          const u = { mode: r.mode, envName: o, parser: r }
          const p = l.handler(u, c, m)
          r.expect("\\end", !1)
          const d = r.nextToken
          const f = Ut(r.parseFunction(), "environment")
          if (f.name !== o)
            throw new n(
    ...
    ot({
      ...
      ot({
        ...
        handler: (e, t) => {
          const r = e.parser
          const n = e.funcName
          const a = e.breakOnTokenText
          const i = r.mode
          const o = r.parseExpression(!0, a)
          return {
            type: "font",
            mode: i,
            font: `math${n.slice(1)}`,
    ...
    const nn = (e, t) => {
      let r
      const n = rn(e.size, t.style)
      const a = n.fracNum()
      const i = n.fracDen()
      r = t.havingStyle(a)
      const o = wt(e.numer, r, t)
      if (e.continued) {
        const s = 8.5 / t.fontMetrics().ptPerEm
        const l = 3.5 / t.fontMetrics().ptPerEm
      ...
      if (
        ...
        const w = t.fontMetrics().axisHeight
        u - o.depth - (w + 0.5 * c) < p &&
    ...
    const an = (e, t) => {
      let r = new Tt.MathNode("mfrac", [Rt(e.numer, t), Rt(e.denom, t)])
      if (e.hasBarLine) {
        if (e.barSize) {
    ...
    const on = ["display", "text", "script", "scriptscript"]
    const sn = (e) => {
      let t = null
    ...
    ot({
      ...
      handler: (e, t) => {
        ...
        const i = t[5]
        const o = lt(t[0])
        const s = "atom" === o.type && "open" === o.family ? sn(o.text) : null
        const l = lt(t[1])
        const h = "atom" === l.type && "close" === l.family ? sn(l.text) : null
        const c = Ut(t[2], "size")
        let m = null
    ...
    const ln = (e, t) => {
      ...
      "supsub" === e.type
        ...
        : (n = Ut(e, "horizBrace"))
      let i
      const o = wt(n.base, t.havingBaseStyle(x.DISPLAY))
      const s = Gt(n, t)
      if (
        (n.isOver
          ? (i = Ke.makeVList(
        ...
        const l = Ke.makeSpan(["mord", n.isOver ? "mover" : "munder"], [i], t)
        i = n.isOver
          ? Ke.makeVList(
              {
                positionType: "firstBaseline",
    ...
    ot({
      ...
      ot({
        ...
        handler: (e, t) => {
          ...
          for (let a = [], i = 0; i < n.length; i++) {
            let o = n[i]
            "~" === o && (o = "\\textasciitilde"),
              a.push({ type: "textord", mode: "text", text: o })
          }
          const s = { type: "text", mode: r.mode, font: "\\texttt", body: a }
      ...
      ot({
        ...
        handler: (e, t) => {
          ...
          const a = e.parser
          const i = e.funcName
          const o = (e.token, Ut(t[0], "raw").string)
          const s = t[1]
          a.settings.strict &&
          ...
          switch (i) {
            ...
            case "\\htmlStyle":
              ...
              break
            case "\\htmlData":
              for (let h = o.split(","), c = 0; c < h.length; c++) {
                const m = h[c].split("=")
                if (2 !== m.length)
    ...
    ot({
      ...
      handler: (e, t, r) => {
        const a = e.parser
        let i = { number: 0, unit: "em" }
        let o = { number: 0.9, unit: "em" }
        let s = { number: 0, unit: "em" }
        let l = ""
        if (r[0])
          for (
            let h = Ut(r[0], "raw").string.split(","), c = 0;
            c < h.length;
            c++
          ) {
            const m = h[c].split("=")
      ...
      htmlBuilder: (e, t) => {
        ...
        const i = { height: F(r + n) }
        a > 0 && (i.width = F(a)), n > 0 && (i.verticalAlign = F(-n))
        const o = new j(e.src, e.alt, i)
        return (o.height = r), (o.depth = n), o
      },
      mathmlBuilder: (e, t) => {
        const r = new Tt.MathNode("mglyph", [])
      ...
      ot({
        ...
        htmlBuilder: (e, t) => {
          ...
          const n = Ke.makeSpan(["fix"], [])
          let a = Ke.makeSpan([e.alignment], [r, n], t)
          const i = Ke.makeSpan(["strut"])
          return (
        ...
        mathmlBuilder: (e, t) => {
          const r = new Tt.MathNode("mpadded", [Rt(e.body, t)])
          if ("rlap" !== e.alignment) {
            const n = "llap" === e.alignment ? "-1" : "-0.5"
    ...
    const mn = (e, t, r, n, a, i, o) => {
      e = Ke.makeSpan([], [e])
      let s
      let h
      let c
      const m = r && l.isCharacterBox(r)
      if (t) {
        const u = wt(t, n.havingStyle(a.sup()), n)
        h = {
          elem: u,
          kern: Math.max(
      ...
      if (r) {
        const p = wt(r, n.havingStyle(a.sub()), n)
        s = {
          elem: p,
          kern: Math.max(
    ...
    const pn = (e, t) => {
      ...
      if (
        ...
        const c = h ? "Size2-Regular" : "Size1-Regular"
        let m = ""
        if (
          ...
          const u = o.italic
          const p = Ke.staticSvg(`${m}Size${h ? "2" : "1"}`, t)
          ;(o = Ke.makeVList(
            {
              positionType: "individualShift",
              children: [
        ...
        const d = ft(a.body, t, !0)
        1 === d.length && d[0] instanceof Z
          ? ((o = d[0]).classes[0] = "mop")
          : (o = Ke.makeSpan(["mop"], d, t))
      } else {
        for (let f = [], g = 1; g < a.name.length; g++)
    ...
    function bn(e, t, r) {
      for (
        let n = ft(e, t, !1), a = t.sizeMultiplier / r.sizeMultiplier, i = 0;
        i < n.length;
        i++
      ) {
        const o = n[i].classes.indexOf("sizing")
        o < 0
    ...
    ot({
      ...
      mathmlBuilder: (e, t) => {
        for (
          let r = qt(e.body, t.withFont("mathrm")), n = !0, a = 0;
          a < r.length;
          a++
        ) {
          const i = r[a]
        ...
        if (n) {
          const s = r.map((e) => e.toText()).join("")
          r = [new Tt.TextNode(s)]
        }
        const l = new Tt.MathNode("mi", r)
        l.setAttribute("mathvariant", "normal")
        const h = new Tt.MathNode("mo", [Bt("\u2061", "text")])
      ...
      ot({
        ...
        htmlBuilder: (e, t) => {
          const r = wt(e.body, t.havingCrampedStyle())
          const n = Ke.makeLineSpan("overline-line", t)
          const a = t.fontMetrics().defaultRuleThickness
          const i = Ke.makeVList(
            {
              positionType: "firstBaseline",
              children: [
        ...
        mathmlBuilder: (e, t) => {
          const r = new Tt.MathNode("mo", [new Tt.TextNode("\u203e")])
          r.setAttribute("stretchy", "true")
          const n = new Tt.MathNode("mover", [Rt(e.body, t), r])
          return n.setAttribute("accent", "true"), n
        },
      }),
      ot({
        ...
        htmlBuilder: (e, t) => {
          const r = ft(e.body, t.withPhantom(), !1)
          return Ke.makeFragment(r)
        },
        mathmlBuilder: (e, t) => {
          const r = qt(e.body, t)
      ...
      ot({
        ...
        htmlBuilder: (e, t) => {
          let r = Ke.makeSpan([], [wt(e.body, t.withPhantom())])
        ...
        mathmlBuilder: (e, t) => {
          const r = qt(ht(e.body), t)
          const n = new Tt.MathNode("mphantom", r)
          const a = new Tt.MathNode("mpadded", [n])
          return (
      ...
      ot({
        ...
        htmlBuilder: (e, t) => {
          const r = Ke.makeSpan(["inner"], [wt(e.body, t.withPhantom())])
          const n = Ke.makeSpan(["fix"], [])
      ...
      ot({
        ...
        names: ["\\relax"],
        props: { numArgs: 0, allowedInText: !0 },
        handler: (e) => ({ type: "internal", mode: e.parser.mode }),
      }),
      ot({
        type: "rule",
        names: ["\\rule"],
        ...
        htmlBuilder: (e, t) => {
          const r = Ke.makeSpan(["mord", "rule"], [], t)
          const n = P(e.width, t)
          const a = P(e.height, t)
          const i = e.shift ? P(e.shift, t) : 0
          return (
        ...
        mathmlBuilder: (e, t) => {
          const r = P(e.width, t)
          const n = P(e.height, t)
          const a = e.shift ? P(e.shift, t) : 0
          const i = (t.color && t.getColor()) || "black"
          const o = new Tt.MathNode("mspace")
          o.setAttribute("mathbackground", i),
            o.setAttribute("width", F(r)),
            o.setAttribute("height", F(n))
          const s = new Tt.MathNode("mpadded", [o])
          return (
            a >= 0
    ...
    ot({
      ...
      props: { numArgs: 0, allowedInText: !0 },
      handler: (e, t) => {
        const r = e.breakOnTokenText
        const n = e.funcName
        const a = e.parser
        const i = a.parseExpression(!1, r)
        return {
          type: "sizing",
          mode: a.mode,
          size: yn.indexOf(n) + 1,
      ...
      mathmlBuilder: (e, t) => {
        const r = t.havingSize(e.size)
        const n = qt(e.body, r)
        const a = new Tt.MathNode("mstyle", n)
      ...
      ot({
        ...
        handler: (e, t, r) => {
          ...
          let a = !1
          let i = !1
          const o = r[0] && Ut(r[0], "ordgroup")
          if (o)
            for (let s = "", l = 0; l < o.body.length; ++l) {
        ...
        htmlBuilder: (e, t) => {
          const r = Ke.makeSpan([], [wt(e.body, t)])
          if (!e.smashHeight && !e.smashDepth) return r
          if (e.smashHeight && ((r.height = 0), r.children))
            for (let n = 0; n < r.children.length; n++) r.children[n].height = 0
          if (e.smashDepth && ((r.depth = 0), r.children))
            for (let a = 0; a < r.children.length; a++) r.children[a].depth = 0
          const i = Ke.makeVList(
            {
              positionType: "firstBaseline",
              children: [{ type: "elem", elem: r }],
      ...
      ot({
        ...
        htmlBuilder: (e, t) => {
          let r = wt(e.body, t.havingCrampedStyle())
          ...
          let i = n + a / 4
          const o = r.height + r.depth + i + n
          const s = Nr.sqrtImage(o, t)
          const l = s.span
          const h = s.ruleWidth
          const c = s.advanceWidth
          const m = l.height - h
          ...
          if (e.index) {
            const d = t.havingStyle(x.SCRIPTSCRIPT)
            const f = wt(e.index, d, t)
            const g = 0.6 * (p.height - p.depth)
            const v = Ke.makeVList(
              {
                positionType: "shift",
                positionData: -g,
    ...
    ot({
      ...
      handler: (e, t) => {
        ...
        const n = e.funcName
        const a = e.parser
        const i = a.parseExpression(!0, r)
        const o = n.slice(1, n.length - 5)
        return { type: "styling", mode: a.mode, style: o, body: i }
      },
      htmlBuilder: (e, t) => {
        const r = xn[e.style]
        const n = t.havingStyle(r).withFont("")
        return bn(e.body, n, t)
      },
      mathmlBuilder: (e, t) => {
        const r = xn[e.style]
        const n = t.havingStyle(r)
        const a = qt(e.body, n)
        const i = new Tt.MathNode("mstyle", a)
        const o = {
          display: ["0", "true"],
          text: ["0", "false"],
          script: ["1", "false"],
    ...
    st({
      ...
      htmlBuilder: (e, t) => {
        ...
        const h = e.sub
        const c = wt(o, t)
        const m = t.fontMetrics()
        let u = 0
        let p = 0
        const d = o && l.isCharacterBox(o)
        if (s) {
          const f = t.havingStyle(t.style.sup())
          ;(n = wt(s, f, t)),
            d ||
              (u =
                c.height -
                (f.fontMetrics().supDrop * f.sizeMultiplier) / t.sizeMultiplier)
        }
        if (h) {
          const g = t.havingStyle(t.style.sub())
          ;(a = wt(h, g, t)),
            d ||
              (p =
                c.depth +
        ...
        let v
        const b = t.sizeMultiplier
        const y = F(0.5 / m.ptPerEm / b)
        let w = null
        if (a) {
          const k =
            e.base &&
        ...
        if (n && a) {
          ;(u = Math.max(u, i, n.depth + 0.25 * m.xHeight)),
            (p = Math.max(p, m.sub2))
          const S = 4 * m.defaultRuleThickness
          if (u - n.depth - (a.height - p) < S) {
            p = S - (u - n.depth) + a.height
            const M = 0.8 * m.xHeight - (u - n.depth)
            M > 0 && ((u += M), (p -= M))
          }
          const z = [
          ...
          const A = [{ type: "elem", elem: a, marginLeft: w, marginRight: y }]
          v = Ke.makeVList(
      ...
      st({
        ...
        mathmlBuilder: (e, t) => {
          const r = new Tt.MathNode("mo", [Bt(e.text, e.mode)])
          if ("bin" === e.family) {
            const n = Nt(e, t)
    ...
    const kn = { mi: "italic", mn: "normal", mtext: "normal" }
    st({
      type: "mathord",
      htmlBuilder: (e, t) => Ke.makeOrd(e, t, "mathord"),
      mathmlBuilder: (e, t) => {
        const r = new Tt.MathNode("mi", [Bt(e.text, e.mode, t)])
        const n = Nt(e, t) || "italic"
      ...
      st({
        ...
        mathmlBuilder: (e, t) => {
          let r
          const n = Bt(e.text, e.mode, t)
          const a = Nt(e, t) || "normal"
          return (
            (r =
              "text" === e.mode
    ...
    st({
      ...
      htmlBuilder: (e, t) => {
        if (Mn.hasOwnProperty(e.text)) {
          ...
          if ("text" === e.mode) {
            const a = Ke.makeOrd(e, t, "textord")
    ...
    const zn = () => {
      const e = new Tt.MathNode("mtd", [])
      return e.setAttribute("width", "50%"), e
    }
    st({
      type: "tag",
      mathmlBuilder: (e, t) => {
        const r = new Tt.MathNode("mtable", [
          new Tt.MathNode("mtr", [
            zn(),
    ...
    const Tn = { "\\textbf": "textbf", "\\textmd": "textmd" }
    const Bn = { "\\textit": "textit", "\\textup": "textup" }
    const Cn = (e, t) => {
      const r = e.font
      return r
        ? An[r]
    ...
    ot({
      ...
      ot({
        ...
        htmlBuilder: (e, t) => {
          const r = wt(e.body, t)
          const n = Ke.makeLineSpan("underline-line", t)
          const a = t.fontMetrics().defaultRuleThickness
          const i = Ke.makeVList(
            {
              positionType: "top",
        ...
        mathmlBuilder: (e, t) => {
          const r = new Tt.MathNode("mo", [new Tt.TextNode("\u203e")])
          r.setAttribute("stretchy", "true")
          const n = new Tt.MathNode("munder", [Rt(e.body, t), r])
          return n.setAttribute("accentunder", "true"), n
        },
      }),
      ot({
        ...
        htmlBuilder: (e, t) => {
          const r = wt(e.body, t)
          const n = t.fontMetrics().axisHeight
          const a = 0.5 * (r.height - n - (r.depth + n))
          return Ke.makeVList(
            {
              positionType: "shift",
              positionData: a,
        ...
        mathmlBuilder: (e, t) =>
          new Tt.MathNode("mpadded", [Rt(e.body, t)], ["vcenter"]),
      }),
      ot({
        type: "verb",
        names: ["\\verb"],
        ...
        htmlBuilder: (e, t) => {
          for (
            let r = Nn(e), n = [], a = t.havingStyle(t.style.text()), i = 0;
            i < r.length;
            i++
          ) {
            let o = r[i]
        ...
        mathmlBuilder: (e, t) => {
          const r = new Tt.TextNode(Nn(e))
          const n = new Tt.MathNode("mtext", [r])
          return n.setAttribute("mathvariant", "monospace"), n
        },
      })
    const Nn = (e) => e.body.replace(/ /g, e.star ? "\u2423" : "\xa0")
    const qn = nt
    const In = "[ \r\n\t]"
    const Rn = `(\\\\[a-zA-Z@]+)${In}*`
    const Hn = "[\u0300-\u036f]"
    const On = new RegExp(`${Hn}+$`)
    ...
    const Ln = (() => {
      ...
      return (
        ...
        (t.lex = function () {
          const e = this.input
          const t = this.tokenRegex.lastIndex
    ...
    Pr("\\noexpand", (e) => {
      ...
      Pr("\\@firstoftwo", (e) => ({ tokens: e.consumeArgs(2)[0], numArgs: 0 })),
      Pr("\\@secondoftwo", (e) => ({
    ...
    Pr("\\char", (e) => {
      ...
      if (t) {
        ...
        for (let i; null != (i = Pn[e.future().text]) && i < t; )
          (a *= t), (a += i), e.popToken()
      }
      return `\\@char{${a}}`
    })
    const Fn = (e, t, r) => {
      let a = e.consumeArg().tokens
      if (1 !== a.length)
        throw new n("\\newcommand's first argument must be a macro name")
      const i = a[0].text
      const o = e.isDefined(i)
      if (o && !t)
        throw new n(
      ...
      if (1 === (a = e.consumeArg().tokens).length && "[" === a[0].text) {
        for (
          let l = "", h = e.expandNextToken();
          "]" !== h.text && "EOF" !== h.text;
        )
          (l += h.text), (h = e.expandNextToken())
        if (!l.match(/^\s*[0-9]+\s*$/))
          throw new n(`Invalid number of arguments: ${l}`)
        ;(s = Number.parseInt(l)), (a = e.consumeArg().tokens)
      }
      return e.macros.set(i, { tokens: a, numArgs: s }), ""
    }
    Pr("\\newcommand", (e) => Fn(e, !1, !0)),
      Pr("\\renewcommand", (e) => Fn(e, !0, !1)),
      Pr("\\providecommand", (e) => Fn(e, !0, !0)),
      Pr("\\message", (e) => {
    ...
    Pr("\\dotso", (e) => (e.future().text in Un ? "\\ldots\\," : "\\ldots")),
      Pr("\\dotsc", (e) => {
        const t = e.future().text
        return t in Un && "," !== t ? "\\ldots\\," : "\\ldots"
      }),
      Pr("\\cdots", (e) =>
        e.future().text in Un ? "\\@cdots\\," : "\\@cdots",
      ),
      Pr("\\dotsb", "\\cdots"),
      Pr("\\dotsm", "\\cdots"),
      Pr("\\dotsi", "\\!\\cdots"),
    ...
    Pr(
      "\\LaTeX",
      `\\textrm{\\html@mathml{L\\kern-.36em\\raisebox{${Yn}}{\\scriptstyle A}\\kern-.15em\\TeX}{LaTeX}}`,
    ),
      Pr(
        "\\KaTeX",
        `\\textrm{\\html@mathml{K\\kern-.17em\\raisebox{${Yn}}{\\scriptstyle A}\\kern-.15em\\TeX}{KaTeX}}`,
      ),
    ...
    const Xn = (e) => (t) => {
      ...
      const n = t.consumeArg().tokens
      const a = t.consumeArg().tokens
      const i = t.consumeArg().tokens
      const o = t.macros.get("|")
      const s = t.macros.get("\\|")
      t.macros.beginGroup()
      const l = (t) => (r) => {
      ...
      const c = t.expandTokens([].concat(i, h, r))
      ...
      return (
        ...
        (t.scanArgument = function (e) {
          ...
          if (e) {
            ...
            t = this.popToken()
            const a = this.consumeArg(["]"])
            ;(n = a.tokens), (r = a.end)
          } else {
            const i = this.consumeArg()
        ...
        (t.consumeArg = function (e) {
          ...
          do {
            if (((a = this.popToken()), t.push(a), "{" === a.text)) ++o
              ...
              throw new n(
                `Unexpected end of input in a macro argument, expected '${e && r ? e[s] : "}"}'`,
                a,
              )
            if (e && r)
        ...
        (t.consumeArgs = function (e, t) {
          if (t) {
            ...
            for (let r = t[0], a = 0; a < r.length; a++) {
          ...
          for (let o = [], s = 0; s < e; s++)
            o.push(this.consumeArg(t?.[s + 1]).tokens)
          return o
        }),
        (t.expandOnce = function (e) {
          const t = this.popToken()
          const r = t.text
          const a = t.noexpand ? null : this._getExpansion(r)
          ...
          let i = a.tokens
          const o = this.consumeArgs(a.numArgs, a.delimiters)
          if (a.numArgs)
            for (let s = (i = i.slice()).length - 1; s >= 0; --s) {
              let l = i[s]
              if ("#" === l.text) {
                if (0 === s)
          ...
          if ("string" === typeof n) {
            ...
            if (-1 !== n.indexOf("#"))
              for (
                ...
                ++a
            for (
              let o = new Ln(n, this.settings), s = [], l = o.lex();
              "EOF" !== l.text;
            )
              s.push(l), (l = o.lex())
    ...
    const Jn = (() => {
      ...
      return (
        ...
        (t.handleInfixNodes = function (e) {
          for (let t, r = -1, a = 0; a < e.length; a++)
            if ("infix" === e[a].type) {
              if (-1 !== r)
        ...
        (t.formatUnsupportedCmd = function (e) {
          ...
          const n = { type: "text", mode: this.mode, body: t }
          return {
            type: "color",
            mode: this.mode,
        ...
        (t.parseAtom = function (t) {
          let r
          let a
          const i = this.parseGroup("atom", t)
          ...
          for (;;) {
            ...
            if ("\\limits" === o.text || "\\nolimits" === o.text) {
              ...
              if (r) throw new n("Double superscript", o)
              const l = { type: "textord", mode: this.mode, text: "\\prime" }
              const h = [l]
              ...
              if (!$n[o.text]) break
              let c = $n[o.text]
              const m = jn.test(o.text)
              for (this.consume(); ; ) {
                const u = this.fetch().text
                if (!$n[u]) break
                if (jn.test(u) !== m) break
                this.consume(), (c += $n[u])
              }
              const p = new e(c, this.settings).parse()
              m
        ...
        (t.parseFunction = function (e, t) {
          ...
          const o = this.parseArguments(a, i)
          const s = o.args
          const l = o.optArgs
          return this.callFunction(a, s, l, r, e)
        }),
        (t.callFunction = function (e, t, r, a, i) {
          const o = { funcName: e, parser: this, token: a, breakOnTokenText: i }
          const s = qn[e]
          if (s?.handler) return s.handler(o, t, r)
        ...
        (t.parseArguments = function (e, t) {
          ...
          for (let a = [], i = [], o = 0; o < r; o++) {
            let s = t.argTypes?.[o]
            const l = o < t.numOptionalArgs
            ;((t.primitive && null == s) ||
              ("sqrt" === t.type && 1 === o && null == i[0])) &&
              (s = "primitive")
            const h = this.parseGroupOfType(`argument to '${e}'`, s, l)
            if (l) i.push(h)
            else {
              if (null == h)
        ...
        (t.parseGroupOfType = function (e, t, r) {
          switch (t) {
            ...
            case "hbox": {
              const a = this.parseArgumentGroup(r, "text")
              return null != a
                ? { type: "styling", mode: a.mode, body: [a], style: "text" }
                : null
            }
            case "raw": {
              const i = this.parseStringGroup("raw", r)
              return null != i
        ...
        (t.parseSizeGroup = function (e) {
          ...
          const a = /([-+]?) *(\d+(?:\.\d*)?|\.\d+) *([a-z]{2})/.exec(t.text)
          if (!a) throw new n(`Invalid size: '${t.text}'`, t)
          const i = { number: +(a[1] + a[2]), unit: a[3] }
        ...
        (t.parseArgumentGroup = function (e, t) {
          ...
          const i = { type: "ordgroup", mode: this.mode, loc: r.loc, body: a }
        ...
        (t.parseGroup = function (e, t) {
          ...
          if ("{" === i || "\\begingroup" === i) {
            ...
            const s = this.parseExpression(!1, o)
            const l = this.fetch()
            this.expect(o),
        ...
        (t.formLigatures = (e) => {
          for (let t = e.length - 1, r = 0; r < t; ++r) {
            const n = e[r]
            const a = n.text
            "-" === a &&
              "-" === e[r + 1].text &&
        ...
        (t.parseSymbol = function () {
          ...
          if ((this.consume(), o))
            for (let m = 0; m < o[0].length; m++) {
              const u = o[0][m]
              if (!Zn[u]) throw new n(`Unknown accent ' ${u}'`, e)
              const p = Zn[u][this.mode] || Zn[u].text
              if (!p)
    ...
    const Qn = (e, t) => {
      ...
      const r = new Jn(e, t)
      r.gullet.macros.current["\\df@tag"] = undefined
      let a = r.parse()
      if (
        ((r.gullet.macros.current["\\current@color"] = undefined),
        (r.gullet.macros.current["\\color"] = undefined),
    ...
    const ta = (e, t, r) => {
      ...
      const a = Ke.makeSpan(["katex-error"], [new Z(t)])
      return (
    ...
    const na = {
      version: "0.16.9",
      render: ea,
      renderToString: (e, t) => ra(e, t).toMarkup(),
      ParseError: n,
      SETTINGS_SCHEMA: h,
      __parse: (e, t) => {
        const r = new m(t)
      ...
      __renderToHTMLTree: (e, t) => {
        const r = new m(t)
        try {
          return ((e, t, r) => {
            const n = St(e, Ot(r))
            const a = Ke.makeSpan(["katex"], [n])
            return Et(a, r)
          })(Qn(e, r), 0, r)
        } catch (t) {
          return ta(t, e, r)
