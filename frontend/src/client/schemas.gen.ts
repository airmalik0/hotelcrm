...
export const CustomerTypeSchema = {
    ...
    enum: ['new', 'returning'],
    title: 'CustomerType',
    description: 'Customer type categories for filtering.'
} as const;
...
export const GroupBySchema = {
    type: 'string',
    enum: ['day', 'week', 'month', 'room', 'payment_method', 'country', 'region', 'district', 'age_group'],
    title: 'GroupBy',
...
export const RoomCategoriesPublicSchema = {
    properties: {
        data: {
            items: {
                '$ref': '#/components/schemas/RoomCategoryPublic'
            },
            type: 'array',
            title: 'Data'
        },
    ...
    type: 'object',
    required: ['data', 'count'],
    title: 'RoomCategoriesPublic'
} as const;

export const RoomCategoryCreateSchema = {
    properties: {
        name: {
            type: 'string',
            maxLength: 100,
    ...
    type: 'object',
    required: ['name'],
    title: 'RoomCategoryCreate'
} as const;

export const RoomCategoryPublicSchema = {
    properties: {
        name: {
            type: 'string',
            maxLength: 100,
...
export const RoomCreateSchema = {
    ...
    type: 'object',
    required: ['room_number', 'floor', 'price_per_night'],
    title: 'RoomCreate'
} as const;
...
export const RoomPublicSchema = {
    ...
    type: 'object',
    required: ['room_number', 'floor', 'price_per_night', 'id', 'created_at'],
    title: 'RoomPublic'
} as const;
