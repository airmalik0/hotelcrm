...
def load_development_context(source):
    ...
    # IMPORTANT: Load CLAUDE.md from project root first
    ...
    if claude_md_path.exists():
        try:
            with open(claude_md_path, "r") as f:
                ...
                if content:
                    context_parts.append(
                        "\n--- IMPORTANT: Project Instructions (CLAUDE.md) ---"
                    )
                    context_parts.append(content)  # Load full content, no limit
        except Exception:
            pass
...
def main():
    try:
        ...
        # Extract fields
        _ = input_data.get("session_id", "unknown")  # session_id not used but kept for logging
